        ...
        <div class="card-box">
          <div class="form-group">
            <label class="col-form-label">角色名称
              <asp:RequiredFieldValidator ControlToValidate="TbRoleName" ErrorMessage=" *" ForeColor="red" Display="Dynamic" runat="server"
              />
              <asp:RegularExpressionValidator runat="server" ControlToValidate="TbRoleName" ValidationExpression="[^',]+" ErrorMessage=" *"
          ...
          <div class="form-group">
            ...
            <div class="m-5">
              <asp:CheckBoxList class="checkbox checkbox-primary" RepeatDirection="Horizontal" RepeatColumns="3" ID="CblPermissions" runat="server"
              />
            </div>
          </div>
