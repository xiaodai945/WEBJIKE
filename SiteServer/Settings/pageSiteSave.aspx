      ...
      <form class="m-l-15 m-r-15" runat="server">
        ...
        <div class="card-box">
          ...
          <asp:PlaceHolder id="PhWelcome" runat="server">
            ...
            <div class="form-group">
              <label class="col-form-label">
                站点模板名称
                <asp:RequiredFieldValidator ControlToValidate="TbSiteTemplateName" errorMessage=" *" foreColor="red" Display="Dynamic" runat="server"
                />
                <asp:RegularExpressionValidator runat="server" ControlToValidate="TbSiteTemplateName" ValidationExpression="[^']+" errorMessage=" *"
            ...
            <div class="form-group">
              <label class="col-form-label">
                站点模板文件夹名称
                <asp:RequiredFieldValidator ControlToValidate="TbSiteTemplateDir" errorMessage=" *" foreColor="red" Display="Dynamic" runat="server"
                />
                <asp:RegularExpressionValidator ControlToValidate="TbSiteTemplateDir" ValidationExpression="^T_.+" errorMessage=" *" foreColor="red"
            ...
            <div class="form-group">
              <label class="col-form-label">
                站点模板网站地址
                <asp:RegularExpressionValidator runat="server" ControlToValidate="TbWebSiteUrl" ValidationExpression="[^']+" errorMessage=" *"
                  foreColor="red" Display="Dynamic" />
              </label>
          ...
          <asp:PlaceHolder id="PhSaveFiles" runat="server" Visible="false">
            ...
            <asp:PlaceHolder ID="PhDirectoriesAndFiles" runat="server" Visible="false">
              <div class="form-group">
                ...
                <asp:CheckBoxList ID="CblDirectoriesAndFiles" RepeatDirection="Horizontal" class="checkbox checkbox-primary" RepeatColumns="5"
          ...
          <div class="text-center">
            <asp:Button class="btn btn-primary m-r-5" id="BtnWelcomeNext" onclick="BtnWelcomeNext_Click" runat="server" text="下一步"></asp:button>
            <asp:Button class="btn btn-primary m-r-5" id="BtnSaveFilesNext" onclick="BtnSaveFilesNext_Click" visible="false" runat="server"
              text="下一步"></asp:button>
            <asp:Button class="btn btn-primary m-r-5" id="BtnSaveSiteContentsNext" onclick="BtnSaveSiteContentsNext_Click" visible="false"
              runat="server" text="下一步"></asp:button>
            <asp:Button class="btn btn-primary m-r-5" id="BtnSaveSiteStylesNext" onclick="BtnSaveSiteStylesNext_Click" visible="false"
              runat="server" text="下一步"></asp:button>
            <asp:Button class="btn btn-primary m-r-5" id="BtnUploadImageFileNext" onclick="BtnUploadImageFileNext_Click" visible="false"
              runat="server" text="下一步"></asp:button>
