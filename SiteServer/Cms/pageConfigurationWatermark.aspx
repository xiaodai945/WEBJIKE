      ...
      <form class="m-l-15 m-r-15" runat="server">
        ...
        <div class="card-box">
          <div class="form-group">
            ...
            <asp:DropDownList ID="DdlIsWaterMark" runat="server" RepeatDirection="Horizontal" class="form-control" AutoPostBack="true"
              OnSelectedIndexChanged="DdlIsWaterMark_SelectedIndexChanged"></asp:DropDownList>
          </div>
          ...
          <asp:PlaceHolder id="PhWaterMarkMin" runat="server">
            <div class="form-group">
              <label class="col-form-label">图片最小尺寸
                <asp:RequiredFieldValidator ControlToValidate="TbWaterMarkMinWidth" ErrorMessage=" *" ForeColor="red" Display="Dynamic" runat="server"
                />
                <asp:RegularExpressionValidator ControlToValidate="TbWaterMarkMinWidth" ValidationExpression="\d+" Display="Dynamic" ErrorMessage="此项必须为数字"
                  foreColor="red" runat="server" />
                <asp:RequiredFieldValidator ControlToValidate="TbWaterMarkMinHeight" ErrorMessage=" *" ForeColor="red" Display="Dynamic"
                  runat="server" />
                <asp:RegularExpressionValidator ControlToValidate="TbWaterMarkMinHeight" ValidationExpression="\d+" Display="Dynamic" ErrorMessage="此项必须为数字"
                  foreColor="red" runat="server" />
              </label>
          ...
          <asp:PlaceHolder id="PhIsImageWaterMark" runat="server">
            <div class="form-group">
              ...
              <asp:DropDownList ID="DdlIsImageWaterMark" runat="server" RepeatDirection="Horizontal" class="form-control" AutoPostBack="true"
                OnSelectedIndexChanged="DdlIsWaterMark_SelectedIndexChanged"></asp:DropDownList>
              <small class="form-text text-muted">
                选择使用的水印类型
              </small>
          ...
          <asp:PlaceHolder id="PhWaterMarkFormatString" runat="server">
            <div class="form-group">
              <label class="col-form-label">文字型水印的内容
                <asp:RequiredFieldValidator ControlToValidate="TbWaterMarkFormatString" ErrorMessage=" *" ForeColor="red" Display="Dynamic"
                  runat="server" />
                <asp:RegularExpressionValidator runat="server" ControlToValidate="TbWaterMarkFormatString" ValidationExpression="[^']+" ErrorMessage="此项不能为空"
          ...
          <asp:PlaceHolder id="PhWaterMarkFontSize" runat="server">
            <div class="form-group">
              <label class="col-form-label">文字水印的大小
                <asp:RequiredFieldValidator ControlToValidate="TbWaterMarkFontSize" ErrorMessage="此项不能为空" foreColor="red" Display="Dynamic"
                  runat="server" />
                <asp:RegularExpressionValidator ControlToValidate="TbWaterMarkFontSize" ValidationExpression="\d+" Display="Dynamic" ErrorMessage="此项必须为数字"
                  foreColor="red" runat="server" />
              </label>
          ...
          <asp:PlaceHolder id="PhWaterMarkImagePath" runat="server">
            <div class="form-group">
              <label class="col-form-label">图片型水印文件
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="TbWaterMarkImagePath" ErrorMessage=" *" ForeColor="red"
