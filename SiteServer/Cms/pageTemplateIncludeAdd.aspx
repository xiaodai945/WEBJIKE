        ...
        <div class="card-box">
          ...
          <div class="form-row">
            <div class="col-md-4 mb-3">
              <label for="TbTemplateName">包含文件名
              ...
              <script type="text/javascript">
                $(document).ready(function () {
                  ...
                  var editor = CodeMirror.fromTextArea('TbContent', {
                    height: "500px",
                    parserfile: ["parsecss.js?v=6.4.1", "tokenizejavascript.js?v=6.4.1", "parsejavascript.js?v=6.4.1", "parsexml.js?v=6.4.1",
                      "parsehtmlmixed.js?v=6.4.1"
                    ],
                    stylesheet: ["../assets/codeMirror/css/xmlcolors.css?v=6.4.1",
                      "../assets/codeMirror/css/csscolors.css?v=6.4.1", "../assets/codeMirror/css/jscolors.css?v=6.4.1"
                    ],
