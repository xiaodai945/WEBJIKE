        ...
        <div class="card-box">
          ...
          <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" readonly class="form-control-plaintext" value=".js?v=6.4.1">
            </div>
            <div class="col-md-4 mb-3">
              ...
              <script type="text/javascript">
                $(document).ready(function () {
                  ...
                  var editor = CodeMirror.fromTextArea('TbContent', {
                    height: "500px",
                    parserfile: ["tokenizejavascript.js?v=6.4.1", "parsejavascript.js?v=6.4.1"],
                    stylesheet: ["../assets/codeMirror/css/jscolors.css?v=6.4.1"],
