<%@ Page Language="C#" ValidateRequest="false" Inherits="SiteServer.BackgroundPages.Cms.PageContentAdd" %>
  <%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
        ...
        <div class="card-box">
          ...
          <div class="basic">
            ...
            <div class="form-group form-row">
              <label class="col-1 col-form-label text-right">标题</label>
              <div class="col-6">
    ...
    <script type="text/javascript" src="../assets/validate.js?v=6.4.1"></script>
    <script type="text/javascript" src="../assets/jquery/jquery.form.js?v=6.4.1"></script>
    <script type="text/javascript" src="../assets/jscolor/jscolor.js?v=6.4.1"></script>
    <script>
